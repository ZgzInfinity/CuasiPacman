...
var
     ...
     exito : boolean;           (* Variable lógica que controla si has pasado del límite de puntuación*)
begin
      ...
      exito:= FALSE;
         ...
         (*-----------------------------------------------------------------------------------------------------------------------*)
                     ...
                     textcolor (lightgreen);
                                                                    (* El bucle termina al pulsar la tecla ESC o
                                                                       sobrepasa los puntos límite *)
                    until (final = TRUE) or (exito = TRUE);
                    ...
                    if exito = TRUE then
                    begin
                    gotoxy (1,25); write (' ENHORABUENA, has conseguido completar la maxima puntuacion.');
                    end;
