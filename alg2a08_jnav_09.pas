      ...
      exterminado:= FALSE;
         ...
         (*-----------------------------------------------------------------------------------------------------------------------*)
              ...
              (*-----------------------------------------------------------------------*)
                      ...
                      if (cbueno = cmalo1) and (fbueno = fmalo1) or (cbueno = cmalo2) and (fbueno = fmalo2) then
                      begin
                      vidas:= vidas - 1;                               (* Las vidas van descencidendo cada vez que te coge uno de los malos *)
                      gotoxy (50,25);
                      write (' Cuidado, has perdido una vida ');      (* Esribo esto cada vez que pierde una vida *)
                      delay (500);
                      write ('                               ');       (* Después del delay de arriba, escribo espacios en blanco, similar a que deja de escribirse *)
