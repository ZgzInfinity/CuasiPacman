                    ...
                    begin
                       case ord(readkey) of
                          TECLA_UP    : begin             (* Si se pulsa la tecla flecha arriba*)
                                          ...
                                          if fbueno = 1 then fbueno:= 2;   (* Al tocar el borde superior, se queda parada en la fila 2, no sigue subiendo *)
                          ...
                          TECLA_DOWN  : begin           (* Si se pulsa la tecla flecha abajo*)
                                           ...
                                           if fbueno = NFIL then fbueno:= NFIL - 1;       (* Al tocar el borde inferior, se queda parada en la fila 23, no sigue subiendo *)
                          ...
                          TECLA_RIGHT    : begin             (* Si se pulsa la tecla flecha derecha *)
                                           ...
                                           if cbueno = NCOL then cbueno:= NCOL - 1;  (* Al tocar el lateral derecho, se queda parada en la columna 79, no sigue moviendose*)
                          ...
                          TECLA_LEFT  : begin                 (* Si se pulsa la tecla flecha izquierda  *)
                                           ...
                                           if cbueno = 1 then cbueno:= 2;        (* Al tocar el lateral izquierdo, se queda parada en la columna 2, no sigue moviendose*)
